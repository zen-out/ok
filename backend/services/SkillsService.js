...
async function how_do_we_motivate_test() {
    ...
    let audrey_skill_two = await skillz.createCharacterSkills(1, ["tests", "readme", "trust in your own experiences", "git commit messages (huskey)", "publishing", "simplicity", "happy husband happy life", "friends on saturday", "teach", "stop having guy friends", "think about what cyrus needs", "get more massages"]);
}
