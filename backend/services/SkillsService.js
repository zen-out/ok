...
async function how_do_we_motivate_test() {
    let audrey_skill_one = await skillz.createCharacterSkills(1, ["self_control", "nurture", "impromptu", "diplomacy", "cooking", "simplicity", "openmindedness", "host", "teach", "reassure", "support", "mentor"]);
    let audrey_skill_two = await skillz.createCharacterSkills(1, ["tests", "readme", "", "git commit messages (huskey)", "publishing", "simplicity", "happy husband happy life", "friends on saturday", "teach", "talk to sam", "think about what cyrus needs", "get more massages"]);
}
